  ...
  install_php() {
    ...
    case ${RELEASE} in
      6*)
        ...
        super -v+ $PACKAGE $PACKAGE_INSTALL php5 php5-dev php5-mcrypt php5-common php5-curl php5-cli php5-gd libapache2-mod-php5 libphp-pclzip php-pear build-essential
        super -v+ a2enmod rewrite
        super -v+ service apache2 restart
      ;;
      7*)
        debug "Install php $DISTRO $RELEASE"
        super -v+ $PACKAGE $PACKAGE_INSTALL php5 php5-dev php5-mcrypt php5-common php5-curl php5-cli php5-gd php5-json php5-xml libapache2-mod-php5 php5-zip php-pear build-essential
        super -v+ a2enmod rewrite
        super -v+ service apache2 restart
      ;;
      8*)
